...
powershell -ExecutionPolicy Bypass -File infra/laptop2/configure-product-database.ps1
...
server key. The database prompt stores the existing `skavan_app` credential as
